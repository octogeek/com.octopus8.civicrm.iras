 ...
 * (GenCodeChecksum:928340a8235cf747a52c4da4b3a269ef)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => E::ts('Unique IrasDonation ID'),
          'required' => TRUE,
          'where' => 'civicrm_iras_donation.id',
        ...
        'contact_id' => [
          ...
          'where' => 'civicrm_iras_donation.contact_id',
          'table_name' => 'civicrm_iras_donation',
          'entity' => 'IrasDonation',
          'bao' => 'CRM_Irasdonation_DAO_IrasDonation',
          'localizable' => 0,
